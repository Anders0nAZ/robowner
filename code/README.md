...
| [`2_News_pulse.py`](running/2_News_pulse.py) | Immutable, pulse-by-pulse audit of injury-triggered roster re-evaluations. |
| [`3_Ordinary_moves.py`](running/3_Ordinary_moves.py) | Frozen ordinary add/drop decisions, including exclusions and near-misses. |
| [`4_FAAB.py`](running/4_FAAB.py) | Private audit of the FAAB pricing behind every ordinary waiver slate. |
| [`5_Roles.py`](running/5_Roles.py) | The fitted inheritance model and the position rooms it prices. |

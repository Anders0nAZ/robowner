...
| [`1_Decisions.py`](running/1_Decisions.py) | Every roster re-evaluation, front to back, whatever started it. |
| [`2_Players.py`](running/2_Players.py) | What a player is worth, what changed, and how the number was arrived at. |
| [`3_Calibration.py`](running/3_Calibration.py) | How the machinery was fitted, and on how much. |

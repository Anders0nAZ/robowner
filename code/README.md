...
| [`2_Value_movers.py`](running/2_Value_movers.py) | Largest time-adjusted changes in expected rest-of-season value. |
| [`3_News_pulse.py`](running/3_News_pulse.py) | Immutable, pulse-by-pulse audit of injury-triggered roster re-evaluations. |
| [`4_Ordinary_moves.py`](running/4_Ordinary_moves.py) | Frozen ordinary add/drop decisions, including exclusions and near-misses. |
| [`5_FAAB.py`](running/5_FAAB.py) | Private audit of the FAAB pricing behind every ordinary waiver slate. |
| [`6_Roles.py`](running/6_Roles.py) | The fitted inheritance model and the position rooms it prices. |

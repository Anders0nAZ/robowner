...
FIELD_GLOSS: dict[str, str] = {
    ...
    "direct_ros": "The simple comparator: two players' weekly-model totals subtracted. Kept for cross-check; the paired figure is authoritative.",
    "prefers_move": "Whether the simple comparator agrees with the simulator.",
    ...
    "over_free_gain": "How much better the claim is than simply taking that free agent.",

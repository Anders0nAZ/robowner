...
def index(paths: list) -> str:
    ...
    return (
        ...
        "a paid one.\n\n"
        "**Not published, deliberately:** the strategy weights (the audience for "
        "this page is also the competition), the identity map of real names, and "
        "the draft plans. Credentials have never been in the repository at all.\n\n"
